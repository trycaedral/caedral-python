...
Official Python client for the [Caedral API](https://caedral.com) (**v2.1.0**). OpenAI-compatible request shapes — point your existing code at Caedral with minimal changes.
